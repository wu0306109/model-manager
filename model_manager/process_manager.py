...
class ProcessManager():
    ...
    def check_process_in_queue(self, process_id: str,
                               process_queue: list) -> bool:
    ...
    def upload_file_request(self, file_name: str, description: str) -> str:
        ...
        new_process = self.create_process(new_process_id, self.file_path,
    ...
    def create_process(self, process_id: str, file_path: str, file_name: str,
                       description: str) -> None:
        process = UploadProcess(process_id, file_path, file_name, description)
        return process

    # api set process stream
    def transport_file(self, process_id: str, file_stream: LimitedStream,
                       file_size: int) -> str:
        waiting_process_id_list = self.load_waiting_process_id()
        ...
        if (not self.check_process_in_queue(process_id,
                                            waiting_process_id_list)):
